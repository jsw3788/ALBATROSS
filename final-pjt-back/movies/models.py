...
class Recommend(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='genre_recommend')
    genre = models.ForeignKey(Genre, on_delete=models.CASCADE, related_name='user_recommend')
